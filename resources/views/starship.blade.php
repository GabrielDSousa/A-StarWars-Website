            ...
            <div class="max-w-md mx-auto bg-gray-900 rounded-xl shadow-md md:max-w-2xl">
                <div class="flex justify-center">
                    ...
                    <div class="p-8">
                        ...
                        <p class="mt-2 text-white">Custo em créditos: {{verifyUnknown($responseBody->cost_in_credits)}}
                            créditos</p>
                        ...
                        <p class="mt-2 text-white">Velocidade atmosférica máxima
                            : {{verifyUnknown($responseBody->max_atmosphering_speed)}}</p>
                        ...
                        <p class="mt-2 text-white">Classe da nave
                            espacial: {{verifyUnknown($responseBody->starship_class)}}</p>
